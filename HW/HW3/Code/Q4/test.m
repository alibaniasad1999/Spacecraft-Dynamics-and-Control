...
clear all
clc
%...Conversion factors: hours = 3600;
days = 24*hours; deg = pi/180;
%...Constants;
mu = 398600; mu3 = 132.712e9; RE = 6378;
%Hours to seconds %Days to seconds %Degrees to radians
%Earth's gravitational parameter (km^3/s^2) %Sun's gravitational parameter (km^3/s^2) %Earth's radius (km)
%...Initial data for each of the three given orbits: type = {'GEO' 'HEO' 'LEO'};
%...GEO
n =1;
